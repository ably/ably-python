...
class ChannelDetails:
    ...
    @staticmethod
    def from_dict(obj):
        kwargs = {'channel_id': obj.get('channelId'), 'status': ChannelStatus.from_dict(obj.get('status'))}
...
class ChannelStatus:
    ...
    @staticmethod
    def from_dict(obj):
        kwargs = {'is_active': obj.get('isActive'), 'occupancy': ChannelOccupancy.from_dict(obj.get('occupancy'))}
...
class ChannelOccupancy:
    ...
    @staticmethod
    def from_dict(obj):
        kwargs = {'metrics': ChannelMetrics.from_dict(obj.get('metrics'))}
...
class ChannelMetrics:
    def __init__(
        self, connections, presence_connections, presence_members, presence_subscribers, publishers, subscribers
    ):
