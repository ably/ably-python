...
class AuthSync(Auth):
    ...
    async def authorize(self, token_params: Optional[dict] = None, auth_options=None):
        return await super().authorize(token_params, auth_options)
    ...
    async def request_token(self, token_params: Optional[dict] = None,
                            ...
                            query_time=None):
        return await super().request_token(token_params, key_name, key_secret, auth_callback, auth_url, auth_method,
    ...
    async def create_token_request(self, token_params: Optional[dict] = None, key_name: Optional[str] = None,
        ...
        return await super().create_token_request(token_params, key_name, key_secret, query_time)

    @force_sync
    async def token_request_from_auth_url(self, method: str, url: str, token_params,
                                          headers, auth_params):
        return await super().token_request_from_auth_url(method, url, token_params, headers, auth_params)
